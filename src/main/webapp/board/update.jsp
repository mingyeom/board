				...
				<div class="row">
					<div class="col-sm-8 blog-main">
						...
						<form id="frm" class="form-horizontal" role="form"
							action="/listUpdate" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="title" name="title"
										value="${postVo.title }" placeholder="제목">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="hidden" class="form-control"
										value="${postVo.content }" placeholder="글내용">
									<textarea name="content" id="content" rows="10" cols="100"
										style="width: 766px; height: 412px;">${postVo.content }</textarea>
								</div>
							</div>

							<div class="form-group">
								<label for="name" class="col-sm-2 control-label">첨부파일</label>
								<div class="col-sm-10" id="file-btn-list">
									<c:forEach items="${uploadList }" var="uploadList">
										<input type="hidden" class="form-control" id="pic" name="pic"
											value="${uploadList.pic }" placeholder="첨부파일">
										<label class="control-label">${uploadList.pic }</label>
									</c:forEach>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="button" class="btn btn-default" id="addBtn"
											value="추가" class="btn btn-default">
									</div>
								</div>
							</div>
							...
							<script type="text/javascript">
								$(function() {
									var addFileTag = "<input type=\"file\" class=\"btn btn-default\" style=\"margin-top:10px;\" multiple=\"chum\" id=\"chum\" name=\"chum\">"; // file tag								
